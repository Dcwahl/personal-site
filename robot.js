...
import { ink as paletteInk, paper as palettePaper } from "./palette.js?v=5";
import { toCameraSpace, projectCameraSpace, ROOM_CAMERA, CAMERA_IN_ROOM } from "./camera.js?v=5";
