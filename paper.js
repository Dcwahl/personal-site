...
import { buildRobot, placeRobot, robotDefaults, robotPresets } from "./robot.js?v=3";
import { buildRoute, doorRoute, stepLength, headingToCamera, START_PHASE } from "./walk.js?v=3";
import {
  mockupToScreen,
  toCameraSpace,
  projectCameraSpace,
