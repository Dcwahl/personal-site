...
import { buildRobot, placeRobot, robotDefaults, robotPresets } from "./robot.js?v=2";
import { buildRoute, doorRoute, stepLength, headingToCamera, START_PHASE } from "./walk.js?v=2";
import {
  mockupToScreen,
  toCameraSpace,
  projectCameraSpace,
