...
import { buildRobot, placeRobot, robotDefaults, robotPresets } from "./robot.js?v=4";
import { buildRoute, doorRoute, stepLength, headingToCamera, START_PHASE } from "./walk.js?v=4";
import {
  mockupToScreen,
  toCameraSpace,
  projectCameraSpace,
